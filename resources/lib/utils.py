    ...
    def login_wrapper(*args, **kwargs):
        with PersistentDict("userdata.pickle") as db:
            if db.get("token"):
                ...
                # db["token"] = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..dQwwUKP8qupOYfC_GfcjHRNPcHMcpZ_mNZyw8rl2oFc'
                db["token"] = guestToken()
                db["isGuest"] = True
                db.flush()
                return func(*args, **kwargs)
